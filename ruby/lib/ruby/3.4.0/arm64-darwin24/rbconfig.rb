...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.4.0/arm64-darwin24")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/kelvinq18oct20/Coding/aiman/build/ruby-vendor")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/kelvinq18oct20/Coding/aiman/build/ruby-vendor' '--with-openssl-dir=/opt/homebrew/opt/openssl@3' '--enable-shared' '--with-libyaml-dir=/opt/homebrew/opt/libyaml' '--with-gmp-dir=/opt/homebrew/opt/gmp' '--with-ext=openssl,psych,+' 'CC=clang'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/kelvinq18oct20/Coding/aiman/build/ruby-vendor"
  ...
  CONFIG["DLDFLAGS"] = "-L/opt/homebrew/Cellar/gmp/6.3.0/lib -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["incflags"] = "-I/opt/homebrew/Cellar/gmp/6.3.0/include"
  ...
  CONFIG["ARFLAGS"] = "rcu "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 17.0.0 (clang-1700.6.3.2)\nTarget: arm64-apple-darwin24.6.0\nThread model: posix\nInstalledDir: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin"
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/opt/homebrew/Cellar/gmp/6.3.0/lib"
  ...
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
  CONFIG["config_target"] = "aarch64-apple-darwin24.6.0"
  ...
  CONFIG["host"] = "$(target)"
  CONFIG["build_os"] = "darwin24.6.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "aarch64"
  CONFIG["build"] = "aarch64-apple-darwin24.6.0"
